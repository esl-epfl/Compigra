...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f80, dense<32> : vector<2xi32>>, #dlti.dl_entry<f64, dense<[32, 64]> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i64, dense<[32, 64]> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>} {
  ...
  ^bb1:  // pred: ^bb0
    ...
    %51 = llvm.add %48, %23  : i32
    cond_br<eq> [%51 : i32, %45 : i32], ^bb5, ^bb2
  ^bb2:  // pred: ^bb1
    %52 = lwi %50 : i32->i32
    %53 = llvm.sub %52, %8  : i32
    %54 = llvm.sub %52, %39  : i32
    %55 = llvm.sub %9, %52  : i32
    %56 = bzfa %54 : i32 [%42, %55]  : i32
    %57 = llvm.add %51, %47  : i32
    %58 = llvm.mul %57, %3  : i32
    %59 = llvm.add %33, %58  : i32
    %60 = llvm.add %57, %23  : i32
    cond_br<eq> [%60 : i32, %45 : i32], ^bb4(%43, %53, %56, %52, %59 : i32, i32, i32, i32, i32), ^bb3(%43, %53, %56, %52, %59, %60 : i32, i32, i32, i32, i32, i32)
  ^bb3(%61: i32, %62: i32, %63: i32, %64: i32, %65: i32, %66: i32):  // 2 preds: ^bb2, ^bb3
    %67 = llvm.add %61, %46  : i32
    %68 = bsfa %62 : i32 [%63, %64]  : i32
    %69 = llvm.sub %67, %68  : i32
    %70 = bsfa %69 : i32 [%68, %67]  : i32
    %71 = lwi %65 : i32->i32
    %72 = llvm.sub %71, %8  : i32
    %73 = llvm.sub %71, %39  : i32
    %74 = llvm.sub %9, %71  : i32
    %75 = bzfa %73 : i32 [%42, %74]  : i32
    %76 = llvm.add %66, %47  : i32
    %77 = llvm.mul %76, %3  : i32
    %78 = llvm.add %33, %77  : i32
    %79 = llvm.add %76, %23  : i32
    cond_br<ne> [%79 : i32, %45 : i32], ^bb3(%70, %72, %75, %71, %78, %79 : i32, i32, i32, i32, i32, i32), ^bb4(%70, %53, %56, %52, %59 : i32, i32, i32, i32, i32)
  ^bb4(%80: i32, %81: i32, %82: i32, %83: i32, %84: i32):  // 2 preds: ^bb2, ^bb3
    %85 = llvm.add %80, %46  : i32
    %86 = bsfa %81 : i32 [%82, %83]  : i32
    %87 = llvm.sub %85, %86  : i32
    %88 = bsfa %87 : i32 [%86, %85]  : i32
    %89 = llvm.add %88, %46  : i32
    %90 = lwi %84 : i32->i32
    %91 = llvm.sub %90, %8  : i32
    %92 = llvm.sub %90, %39  : i32
    %93 = llvm.sub %9, %90  : i32
    %94 = bzfa %92 : i32 [%42, %93]  : i32
    %95 = bsfa %91 : i32 [%94, %90]  : i32
    %96 = llvm.sub %89, %95  : i32
    %97 = bsfa %96 : i32 [%95, %89]  : i32
    llvm.br ^bb6(%97 : i32)
  ^bb5:  // pred: ^bb1
    %98 = llvm.add %43, %46  : i32
    %99 = lwi %50 : i32->i32
    %100 = llvm.sub %99, %8  : i32
    %101 = llvm.sub %99, %39  : i32
    %102 = llvm.sub %9, %99  : i32
    %103 = bzfa %101 : i32 [%42, %102]  : i32
    %104 = bsfa %100 : i32 [%103, %99]  : i32
    %105 = llvm.sub %98, %104  : i32
    %106 = bsfa %105 : i32 [%104, %98]  : i32
    llvm.br ^bb6(%106 : i32)
  ^bb6(%107: i32):  // 2 preds: ^bb4, ^bb5
    %108 = llvm.mlir.constant(2048 : i32) : i32
    %109 = llvm.mlir.constant(12 : i32) : i32
    %110 = llvm.mlir.constant(0 : i32) : i32
    %111 = llvm.add %109, %110  : i32
    %112 = llvm.mlir.constant(12 : i32) : i32
    %113 = llvm.shl %111, %112  : i32
    %114 = llvm.add %108, %113  {constant = 51200 : i32} : i32
    swi %107, %114 : i32, i32
    llvm.return %10 : i32
  }
}
