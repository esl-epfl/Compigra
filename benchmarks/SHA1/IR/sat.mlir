...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f64, dense<[32, 64]> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i64, dense<[32, 64]> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<f80, dense<32> : vector<2xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>} {
  ...
  ^bb1:  // pred: ^bb0
    ...
    %58 = llvm.mul %52, %19  : i32
    %59 = llvm.add %52, %29  : i32
    cond_br<eq> [%59 : i32, %50 : i32], ^bb5, ^bb2
  ^bb2:  // pred: ^bb1
    %60 = llvm.add %36, %54  : i32
    %61 = lwi %60 : i32->i32
    %62 = llvm.add %39, %56  : i32
    %63 = lwi %62 : i32->i32
    %64 = llvm.xor %63, %61  : i32
    %65 = llvm.mul %57, %9  : i32
    %66 = llvm.add %42, %65  : i32
    %67 = lwi %66 : i32->i32
    %68 = llvm.add %52, %28  : i32
    %69 = llvm.mul %68, %14  : i32
    %70 = llvm.add %45, %69  : i32
    %71 = llvm.add %48, %58  : i32
    %72 = llvm.add %59, %51  : i32
    %73 = llvm.add %72, %25  : i32
    %74 = llvm.mul %73, %33  : i32
    %75 = llvm.add %72, %26  : i32
    %76 = llvm.mul %75, %4  : i32
    %77 = llvm.add %72, %27  : i32
    %78 = llvm.mul %72, %19  : i32
    %79 = llvm.add %72, %29  : i32
    cond_br<eq> [%79 : i32, %50 : i32], ^bb4(%64, %67, %70, %71, %74, %76, %77, %72, %78 : i32, i32, i32, i32, i32, i32, i32, i32, i32), ^bb3(%64, %67, %70, %71, %74, %76, %77, %72, %78, %79 : i32, i32, i32, i32, i32, i32, i32, i32, i32, i32)
  ^bb3(%80: i32, %81: i32, %82: i32, %83: i32, %84: i32, %85: i32, %86: i32, %87: i32, %88: i32, %89: i32):  // 2 preds: ^bb2, ^bb3
    %90 = llvm.xor %80, %81  : i32
    %91 = lwi %82 : i32->i32
    %92 = llvm.xor %90, %91  : i32
    swi %92, %83 : i32, i32
    %93 = llvm.add %36, %84  : i32
    %94 = lwi %93 : i32->i32
    %95 = llvm.add %39, %85  : i32
    %96 = lwi %95 : i32->i32
    %97 = llvm.xor %96, %94  : i32
    %98 = llvm.mul %86, %9  : i32
    %99 = llvm.add %42, %98  : i32
    %100 = lwi %99 : i32->i32
    %101 = llvm.add %87, %28  : i32
    %102 = llvm.mul %101, %14  : i32
    %103 = llvm.add %45, %102  : i32
    %104 = llvm.add %48, %88  : i32
    %105 = llvm.add %89, %51  : i32
    %106 = llvm.add %105, %25  : i32
    %107 = llvm.mul %106, %33  : i32
    %108 = llvm.add %105, %26  : i32
    %109 = llvm.mul %108, %4  : i32
    %110 = llvm.add %105, %27  : i32
    %111 = llvm.mul %105, %19  : i32
    %112 = llvm.add %105, %29  : i32
    cond_br<ne> [%112 : i32, %50 : i32], ^bb3(%97, %100, %103, %104, %107, %109, %110, %105, %111, %112 : i32, i32, i32, i32, i32, i32, i32, i32, i32, i32), ^bb4(%64, %67, %70, %71, %74, %76, %77, %72, %78 : i32, i32, i32, i32, i32, i32, i32, i32, i32)
  ^bb4(%113: i32, %114: i32, %115: i32, %116: i32, %117: i32, %118: i32, %119: i32, %120: i32, %121: i32):  // 2 preds: ^bb2, ^bb3
    %122 = llvm.xor %113, %114  : i32
    %123 = lwi %115 : i32->i32
    %124 = llvm.xor %122, %123  : i32
    swi %124, %116 : i32, i32
    %125 = llvm.add %36, %117  : i32
    %126 = lwi %125 : i32->i32
    %127 = llvm.add %39, %118  : i32
    %128 = lwi %127 : i32->i32
    %129 = llvm.xor %128, %126  : i32
    %130 = llvm.mul %119, %9  : i32
    %131 = llvm.add %42, %130  : i32
    %132 = lwi %131 : i32->i32
    %133 = llvm.xor %129, %132  : i32
    %134 = llvm.add %120, %28  : i32
    %135 = llvm.mul %134, %14  : i32
    %136 = llvm.add %45, %135  : i32
    %137 = lwi %136 : i32->i32
    %138 = llvm.xor %133, %137  : i32
    %139 = llvm.add %48, %121  : i32
    swi %138, %139 : i32, i32
    llvm.br ^bb6
  ^bb5:  // pred: ^bb1
