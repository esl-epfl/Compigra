//===- SCFToCFConversion.cpp - SCF to CF conversion -----------------------===//
//
...
struct SCFToControlFlowPass
    : public compigra::impl::SCFToControlFlowBase<SCFToControlFlowPass> {
...
void compigra::populateSCFToControlFlowConversionPatterns(
...
std::unique_ptr<Pass> compigra::createSCFToControlFlowPass() {
